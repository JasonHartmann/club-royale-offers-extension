            ...
            try {
                ...
                try {
                    if (!document.getElementById('gobo-itinerary-highlight-style')) {
                        ...
                        style.textContent = `\n                            .gobo-itinerary-highlight { animation: gobo-itin-flash 1s ease-in-out; background: rgba(255,245,170,0.9) !important; transition: background .3s, box-shadow .3s; box-shadow: 0 0 0 3px rgba(255,230,120,0.4) inset; }\n                            @keyframes gobo-itin-flash { 0% { background: rgba(255,245,170,0.0);} 30% { background: rgba(255,245,170,0.95);} 100% { background: rgba(255,245,170,0.9);} }\n                            body.gobo-dark .gobo-itinerary-highlight { animation: gobo-itin-flash-dark 1s ease-in-out; background: rgba(120,53,15,0.95) !important; color:#fffbeb; box-shadow: 0 0 0 3px rgba(245,158,11,0.35) inset; }\n                            body.gobo-dark .gobo-itinerary-highlight a { color: inherit; }\n                            @keyframes gobo-itin-flash-dark { 0% { background: rgba(120,53,15,0.0);} 30% { background: rgba(120,53,15,0.98);} 100% { background: rgba(120,53,15,0.95);} }\n                        `;
